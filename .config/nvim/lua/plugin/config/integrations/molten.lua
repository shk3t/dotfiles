...
keymap("x", "<Space>j", cmds.preserve_pos(":<C-U>MoltenEvaluateVisual<CR>"), { silent = true })
...
autocmd("BufAdd", {
  pattern = { "*.ipynb" },
  callback = utils.init_molten_buffer,
})
