...
local private = sugar.require_or("plugin.private.database", { itr_configs = {}, my_db_pass = "unknown" })
...
M.local_configs = tables.merge_lists(M.local_configs, private.itr_configs)
